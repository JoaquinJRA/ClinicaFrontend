...
function Login() {
  ...
  return (
    <AuthLayout>
      <form
        className="w-full max-w-[560px] rounded-3xl bg-white p-10 shadow-xl"
      ...
      >
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-bold text-[#1A3A6B]">Bienvenido de Vuelta</h1>
        ...
        <div className="space-y-6">
          ...
          <label className="block">
            <span className="mb-2 flex items-center justify-between text-sm font-semibold text-[#111827]">
              Contraseña
              <a className="font-medium text-[#2563EB] hover:text-[#1A3A6B]" href="#recuperar">
        ...
        <p className="mt-8 text-center text-sm text-[#6B7280]">
          ¿No tiene una cuenta?{' '}
          <Link className="font-semibold text-[#2563EB] hover:text-[#1A3A6B]" to="/register">
            Registrarse
          </Link>
        </p>
      </form>
