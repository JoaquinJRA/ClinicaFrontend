...
function AuthLayout({ children }) {
  return (
    <main className="grid h-screen min-h-180 grid-cols-[40%_60%] overflow-hidden bg-[#F3F4F6] font-sans">
      ...
      <section className="relative flex h-full items-end overflow-hidden bg-[#1A3A6B] px-12 py-14 text-white">
        ...
        <div className="relative max-w-sm">
          ...
          <p className="text-xl font-medium leading-relaxed text-white/90">
            Donde la medicina moderna se une al máximo confort. Acceda a su
            portal pacientes.
          </p>
        </div>
      </section>
